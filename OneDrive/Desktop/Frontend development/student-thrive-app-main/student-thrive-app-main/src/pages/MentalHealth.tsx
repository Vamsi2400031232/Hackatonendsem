...
export default function MentalHealth() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative h-80 overflow-hidden bg-gradient-to-r from-primary to-primary-light">
        <img 
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl text-primary-foreground">
            ...
            <p className="text-xl opacity-95">
              Discover mindfulness practices, stress management techniques, and emotional well-being resources
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        {programs.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-muted-foreground">No mental health programs available yet.</p>
          </div>
        )}
      </div>
    </div>
