...
export default function Nutrition() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative h-80 overflow-hidden bg-gradient-to-r from-accent to-secondary">
        <img 
          src={nutritionImage}
          alt="Nutrition"
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl text-primary-foreground">
            <h1 className="text-5xl font-bold mb-4">Nutrition & Healthy Eating</h1>
            <p className="text-xl opacity-95">
              Learn about healthy eating habits, meal planning, and nutritional guidance
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        {programs.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-muted-foreground">No nutrition programs available yet.</p>
          </div>
        )}
      </div>
    </div>
